import { commonPay as platformCommonPay, getPlatform, pay as platformPay } from '@tmo/platform-adapter'
...
export const createPaymentServices = (config: PaymentServicesConfig = {}): PaymentServices => {
  ...
  const createSession = async (
    ...
    const response = channel === 'wechat_b2b'
      ? await postPaymentsWechatB2bCreate({ orderId }, requestOptions)
      : channel === 'wechat'
