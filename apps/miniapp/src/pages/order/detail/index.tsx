    ...
    <View className='page order-detail-page'>
      ...
      <View className='page-content order-detail-content'>
        <View className='order-detail-hero'>
          ...
          {order && paymentAvailability?.available === false && readPaymentStatus(order).toUpperCase() !== 'PAID' ? (
      ...
      <View className='order-detail-footer'>
        {paymentAvailability?.available !== false && (canContinuePay(order) || canRefreshPayment(order)) ? (
