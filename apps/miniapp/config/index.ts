...
const defineConstants = {
  ...
  __TMO_PAYMENT_BASE_URL__: JSON.stringify(process.env.TARO_APP_PAYMENT_BASE_URL ?? ''),
  ...
  __TMO_PAYMENT_DEV_TOKEN__: JSON.stringify(process.env.TARO_APP_PAYMENT_DEV_TOKEN ?? ''),
