...
func ProductImportTemplate() TemplateSpec {
	return TemplateSpec{
		...
		Columns: []TemplateColumn{
			...
			{Key: "skuid", Header: "SKU ID"},
			{Key: "productstatus", Header: "Product Status"},
			{Key: "spec1name", Header: "Spec 1 Name"},
			{Key: "spec1value", Header: "Spec 1 Value"},
			{Key: "spec2name", Header: "Spec 2 Name"},
			{Key: "spec2value", Header: "Spec 2 Value"},
			{Key: "spec3name", Header: "Spec 3 Name"},
			{Key: "spec3value", Header: "Spec 3 Value"},
			{Key: "skucode", Header: "SKU Code"},
