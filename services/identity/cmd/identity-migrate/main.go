...
func resolveMigrationsDir() (string, error) {
	if value := os.Getenv("IDENTITY_MIGRATIONS_DIR"); value != "" {
		return value, nil
	}
	...
	candidates := []string{
		...
		filepath.Join(cwd, "services", "identity", "migrations"),
		filepath.Join(cwd, "..", "migrations"),
	}
	...
	return "", fmt.Errorf("migrations directory not found; set IDENTITY_MIGRATIONS_DIR")
}
